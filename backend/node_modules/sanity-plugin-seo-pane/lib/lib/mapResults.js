...
function mapResult(result) {
  ...
  var mappedResult = {
    ...
    id,
    text: result.text,
    markerId: key.length > 0 ? "".concat(key, ":").concat(id) : id
...
function getIconForScore(score) {
  var icon = {
    icon: 'seo-score-none',
    color: _colors.colors.$color_grey_disabled
  };
  ...
  switch (score) {
    case 'loading':
      icon = {
        ...
        color: _colors.colors.$color_green_medium_light
      };
      break;
    ...
    case 'good':
      icon = {
        icon: 'seo-score-good',
        color: _colors.colors.$color_green_medium
      };
      break;
    ...
    case 'bad':
      icon = {
        icon: 'seo-score-bad',
        color: _colors.colors.$color_red
      };
      break;
